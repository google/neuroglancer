...
@export_tool
class VolumeRenderingScaleTool(Tool):
    __slots__ = ()
    TOOL_TYPE = "volumeRenderingScale"
...
class Layer(JsonObjectWrapper):
    ...
    layer_dimensions = layerDimensions = wrapped_property(
...
if typing.TYPE_CHECKING:
    _LayerDataSourcesBase = TypedList[LayerDataSource]
else:
...
class ImageLayer(Layer, _AnnotationLayerOptions):
    ...
    volume_rendering_scale = VolumeRenderingScale = wrapped_property(
        "volumeRenderingScale", optional(float, 64)
    )
