...
from neuroglancer.ingest.base import PROJECT_NAME, QUEUE_NAME, credentials_path
...
client = google.cloud.logging.Client.from_service_account_json(credentials_path(), project=PROJECT_NAME)
