...
- add color picker
- create persistant storage (e.g. via a server and local with IndexedDB) (see [data-saving-plan.md](../NOTES/data-saving-plan.md))
...
- should the backend contain the full map or should it just contain the displayed and surrounding chunks and retrieve the rest live from the datasource (this is a yes for me)
