...
- add shortcuts for tools (switching tools, toggle erase mode, select label from the pointed one in the slice view and adjusting brush size) and label creation
