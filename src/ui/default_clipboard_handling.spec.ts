...
describe("default_clipboard_handling", () => {
  describe("parsePositionString", () => {
    ...
    it("works on basic cases", () => {
      ...
      expect(parsePositionString("1 2 3 4", 4)).toEqual(
        Float32Array.of(1, 2, 3, 4),
      );
      expect(parsePositionString("1 2", 2)).toEqual(Float32Array.of(1, 2));
      expect(parsePositionString("10 2 3", 3)).toEqual(
        Float32Array.of(10, 2, 3),
      );
      expect(parsePositionString("[1 2 3", 3)).toEqual(
      ...
      expect(parsePositionString("1.2 2.4 3", 3)).toEqual(
        Float32Array.of(1.2, 2.4, 3),
      );
      expect(parsePositionString("{200, 400, 500}", 3)).toEqual(
        Float32Array.of(200, 400, 500),
      );
    });
  });
});
