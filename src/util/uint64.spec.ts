...
describe("uint64", () => {
  ...
  it("conversion to string", () => {
    ...
    expect(new Uint64(0, 1).toString(2)).toEqual(
      "100000000000000000000000000000000",
    );
    expect(new Uint64(0, 1).toString(36)).toEqual("1z141z4");
    expect(new Uint64(4294967295, 4294967295).toString()).toEqual(
  ...
  it("conversion from string", () => {
    ...
    expect(new Uint64(0, 1).tryParseString("102002022201221111211", 3)).toBe(
      true,
    );
    expect(
      new Uint64(0, 1).tryParseString("100000000000000000000000000000000", 2),
    ).toBe(true);
    expect(new Uint64(0, 1).tryParseString("1z141z4", 36)).toBe(true);
    expect(
      new Uint64(4294967295, 4294967295).tryParseString("18446744073709551615"),
    ).toBe(true);
    expect(
      new Uint64(4294967295, 4294967295).tryParseString("3w5e11264sgsf", 36),
    ).toBe(true);
  });

  it("equal", () => {
    const a = new Uint64(1, 2);
    const b = new Uint64(1, 2);
