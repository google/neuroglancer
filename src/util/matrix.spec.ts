...
describe("matrix identity", () => {
  it("works for n=0", () => {
    expect(matrix.identity(new Float32Array(0), 1, 0)).toEqual(
      Float32Array.of(),
    );
  });
  it("works for n=1", () => {
    expect(matrix.identity(new Float32Array(1), 1, 1)).toEqual(
      Float32Array.of(1),
    );
  });
  it("works for n=2", () => {
    expect(matrix.identity(new Float32Array(4), 2, 2)).toEqual(
      Float32Array.from([
        1,
        0, //
        0,
  ...
  it("works for n=2 with lda 3", () => {
    expect(matrix.identity(new Float32Array(6), 3, 2)).toEqual(
      Float32Array.from([
        1,
        0,
        0, //
  ...
  it("works for n=3", () => {
    expect(matrix.identity(new Float32Array(9), 3, 3)).toEqual(
      Float32Array.from([
        1,
        0,
        0, //
...
describe("createHomogeneousScaleMatrix", () => {
  it("works for rank 0", () => {
    expect(matrix.createHomogeneousScaleMatrix(Float64Array, [])).toEqual(
      Float64Array.from([1]),
    );
  });
  it("works for rank 1", () => {
    expect(matrix.createHomogeneousScaleMatrix(Float64Array, [2])).toEqual(
      Float64Array.from([
        2,
        0, //
        0,
  ...
  it("works for rank 2", () => {
    expect(matrix.createHomogeneousScaleMatrix(Float64Array, [2, 3])).toEqual(
      Float64Array.from([
        2,
        0,
        0, //
  ...
  it("works for rank 3", () => {
    expect(
      matrix.createHomogeneousScaleMatrix(Float64Array, [2, 3, 4]),
    ).toEqual(
      Float64Array.from([
        2,
        0,
