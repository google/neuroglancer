...
import {glsl_addUint32, setVec4FromUint32, glsl_divmodUint32, gsls_fuzzyEqual} from 'neuroglancer/webgl/shader_lib';
...
export class RenderHelper extends RefCounted {
  ...
  defineShader(builder: ShaderBuilder) {
    ...
    builder.addVertexCode(gsls_fuzzyEqual);
...
if (fuzzyEqual(uSelectedIndex, quotient.value)) {
