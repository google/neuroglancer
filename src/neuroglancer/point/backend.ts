...
import {POINT_RENDERLAYER_RPC_ID, RenderLayer as RenderLayerInterface, PointChunkSource as PointChunkSourceInterface, PointChunkSpecification} from 'neuroglancer/point/base';
...
export class PointChunk extends SliceViewChunk {
    ...
    freeSystemMemory() { this.vertexPositions = null; }
