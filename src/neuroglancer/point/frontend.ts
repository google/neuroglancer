...
import {SliceViewChunkSource, SliceViewChunk, MultiscaleSliceViewChunkSource} from 'neuroglancer/sliceview/frontend';
import {RenderLayer as GenericSliceViewRenderLayer} from 'neuroglancer/sliceview/renderlayer';
import {PointChunkSource as PointChunkSourceInterface, PointChunkSpecification, PointSourceOptions, POINT_RENDERLAYER_RPC_ID} from 'neuroglancer/point/base';
...
export abstract class PointChunkSource extends SliceViewChunkSource implements PointChunkSourceInterface {
    ...
    getChunk(x: any): PointChunk { return new PointChunk(this, x); }

    /**
     * Specifies whether the point vertex coordinates are specified in units of voxels rather than
     * nanometers.
     */
    get pointVertexCoordinatesInVoxels() { return true; } 
};

export class ParameterizedPointSource<Parameters> extends PointChunkSource {
    constructor(chunkManager: ChunkManager, spec: PointChunkSpecification, public parameters: Parameters) { super(chunkManager, spec); }
    ...
    parametersConstructor: ChunkSourceParametersConstructor<Parameters>) {
        const newConstructor = 
            class SpecializedParameterizedPointSource extends ParameterizedPointSource<Parameters> {
                constructor(chunkManager: ChunkManager, spec: PointChunkSpecification, public parameters: Parameters) {
                ...
                static get(chunkManager: ChunkManager, spec: PointChunkSpecification, parameters: Parameters) {
                    return chunkManager.getChunkSource(
                        this, stableStringify({parameters, spec: spec.toObject()}), () => new this(chunkManager, spec, parameters));
                }
