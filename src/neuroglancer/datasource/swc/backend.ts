...
import {MeshSourceParameters, SkeletonSourceParameters, VolumeChunkEncoding, VolumeChunkSourceParameters} from 'neuroglancer/datasource/swc/base';
...
@registerSharedObject() export class SWCMeshSource extends
...
@registerSharedObject() export class SWCVolumeChunkSource extends
