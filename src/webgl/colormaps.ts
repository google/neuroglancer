...
const VIRIDIS_R: [number, number, number, number, number, number, number] = [
  0.2777273272234177, 0.1050930431085774, -0.1554846426062665,
  4.421483672780069, -6.449900613484578, 4.985027369390448, -1.630030898948953,
];
const VIRIDIS_G: [number, number, number, number, number, number, number] = [
  0.005407344544966578, 1.404613529898575, 0.214847559468114,
  -4.815752998712279, 6.814218890839987, -5.374467529984653, 2.019384888944737,
];
const VIRIDIS_B: [number, number, number, number, number, number, number] = [
  0.3340998053353061, 0.5139045538019999, 0.2882845726573711,
  -1.523304699551617, 1.586319730987697, -1.049898449823647, 0.3665667028843458,
];
