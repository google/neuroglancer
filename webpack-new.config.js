...
//	https: true,
//	https: {
//	  key: fs.readFileSync('/etc/pki/tls/certs/cels-incommon.anl.gov-key.pem'),
//          cert: fs.readFileSync('/etc/pki/tls/certs/cels-incommon.anl.gov-bundle.pem'),
        //  ca: fs.readFileSync('/etc/pki/tls/certs/cels-incommon.anl.gov-key.pem')
//        },
	client: {
          webSocketURL: 'https://neuroglancer.cels.anl.gov/sockjs-node',
		overlay: {
    ...
    //    type: "wss",
    //    options: {
    //      host: "neuroglancer.cels.anl.gov",
//	  port: 443,
//	  path: "/sockjs-node",
//        },
//      },
